...
//Name: tower_base_bak.ma
//Last modified: Fri, Mar 01, 2013 09:28:06 PM
//Codeset: UTF-8
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.6177168557544102 5.8677066658043557 -1.7482062538785408 ;
	setAttr ".r" -type "double3" -36.338352730807934 464.99999999987773 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 8.791649171033475;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.13903236857071952 0.47203706047335975 100.10374724723351 ;
...
createNode mesh -n "pPrismShape2" -p "pPrism6";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 40 ".pt";
	setAttr ".pt[48:71]" -type "float3" -2.9802322e-08 4.4703484e-08 8.1956387e-08  
	...
	setAttr ".pt[80:91]" -type "float3" 0.0074950205 0.20889613 -0.018544553  0.012312557 
...
connectAttr ":initialShadingGroup.mwc" "|polySurface12|transform13|polySurfaceShape2.iog.og[0].gco"
		;
connectAttr "deleteComponent23.og" "polySurfaceShape3.i";
connectAttr "groupId13.id" "polySurfaceShape3.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "polySurfaceShape3.iog.og[0].gco";
connectAttr "polyExtrudeFace14.out" "pPrismShape2.i";
