...
QMAKE    = /usr/bin/qmake
towerDefence.xcodeproj/project.pbxproj: towerDefence.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o towerDefence.xcodeproj/project.pbxproj towerDefence.pro
