...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Nov 22 11:27:22 2012
...
INCPATH       = -I/opt/QtSDK/Desktop/Qt/4.8.1/gcc/mkspecs/linux-g++ -I. -I/opt/QtSDK/Desktop/Qt/4.8.1/gcc/include/QtCore -I/opt/QtSDK/Desktop/Qt/4.8.1/gcc/include -Iinclude -I/usr/local/include/OpenEXR -I.
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/opt/QtSDK/Desktop/Qt/4.8.1/gcc/lib
LIBS          = $(SUBLIBS)  -L/opt/QtSDK/Desktop/Qt/4.8.1/gcc/lib -L/usr/lib64 -lImath -lQtCore -L/opt/QtSDK/Desktop/Qt/4.8.1/gcc/lib -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/towerDefence1.0.0/ && $(COPY_FILE) --parents include/entity.h obj/towerDefence1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/entity.cpp obj/towerDefence1.0.0/ && (cd `dirname obj/towerDefence1.0.0` && $(TAR) towerDefence1.0.0.tar towerDefence1.0.0 && $(COMPRESS) towerDefence1.0.0.tar) && $(MOVE) `dirname obj/towerDefence1.0.0`/towerDefence1.0.0.tar.gz . && $(DEL_FILE) -r obj/towerDefence1.0.0
